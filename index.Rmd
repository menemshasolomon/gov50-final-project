...
These results beget the conclusion that passing automatic registration policy is not seen as the same as abolishing voter ID laws in the United States. Indeed, while those who support voter id laws correlate somewhat with those who support automatic registration, the explanatory variable with the largest impact on perspective is party membership. Despite this, there is not enough data in this study to determine any sort of causal relationship, merely assert that there is definite correlation. To conduct a more comprehensive analysis of the various influences which determine an individual's perspective on voter registration, it is important to look at many policies across time. This would require conducting a longitudinal study to analyze how perspectives on automatic registration have changed in response to various changes in both policy and discourse. Furthermore, through asking more in-depth questions, it would be possible to perform in-depth party analysis as well, assessing if particular sects of the democratic party — be it identity groups, regional groups, or other — favor certain policies over others. Through detailed analysis of the mechanisms by which individuals come to support certain voter registration policies, like automatic registration, it will be possible to formulate politically feasible policies which will truly expand voting access and combat disenfranchisement in the United States.
